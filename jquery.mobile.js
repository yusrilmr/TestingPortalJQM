// NOTE The slider widget has been renamed to jqmslider to avoid conflicts with jQuery UI slider widget for the timepicker in the datepicker.
// For production a jQuery Mobile custom build (http://jquerymobile.com/download-builder/) can be used where the slider widget is not included.

/*!
* jQuery Mobile <%= version %>
* Git HEAD hash: 2f00774740d2547c9d15ec786e5663a42ec53cf5 <> Date: Mon Jul 25 2016 08:29:22 UTC
...
$.widget( "mobile.jqmslider", $.extend( {
	version: "@VERSION",
...
return $.widget( "mobile.jqmslider", $.mobile.jqmslider, $.mobile.widget.theme );
...
if ( $.mobileBackcompat !== false ) {
	...
	$.widget( "mobile.jqmslider", $.mobile.jqmslider, {
		options: {
			corners: true,
			mini: false,
			highlight: false
	...
	$.widget( "mobile.jqmslider", $.mobile.jqmslider, $.mobile.widget.backcompat );

}

return $.mobile.jqmslider;
...
return $.widget( "mobile.jqmslider", $.mobile.jqmslider, {
	options: {
		popupEnabled: false,
		showValue: false
	},
